...
<section class="step">
  <div class="step-head"><span class="step-num">1</span><span class="step-title">Le lancement — l'écran d'accueil</span></div>
  <div class="step-body">
...
<section class="step">
  <div class="step-head"><span class="step-num">2</span><span class="step-title">La découverte — les 4 premiers écrans</span></div>
  <div class="step-body">
    <img src="captures/mobile/02-onboarding-1.png" alt="Découverte" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">📖</span>Quatre promesses, quatre écrans</div>
      <ol>
      ...
      <p>Tu peux <strong>glisser vers la gauche</strong> entre les écrans, ou taper sur :chip[Passer] pour aller directement à la connexion.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">3</span><span class="step-title">Se connecter à son compte</span></div>
  <div class="step-body">
    <img src="captures/mobile/06-login.png" alt="Connexion" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">🔑</span>« Bon retour »</div>
      <p>Renseigne deux champs :</p>
      <ul>
      ...
      <p>Mot de passe oublié ? Tape sur :chip[Mot de passe oublié ?] — un lien de réinitialisation t'est envoyé par email.</p>
      <p>Pas encore membre ? :btnOutline[Devenir membre] ouvre le formulaire d'adhésion (étape 4).</p>
      <p>Une fois rempli, appuie sur :btn[Se connecter].</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">4</span><span class="step-title">Devenir membre — le formulaire d'adhésion</span></div>
  <div class="step-body full-card">
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">📝</span>Huit champs prévus par le Règlement Intérieur (Article 3)</div>
      <p>Le bouton :btnOutline[Devenir membre] ouvre une fenêtre avec le formulaire d'adhésion. Tu y remplis :</p>
      <ol>
      ...
      <p>Une fois envoyé, tu reçois un email de confirmation. La coopérative étudie ton dossier puis te programme un <strong>entretien d'admission</strong> en agence. Après décision favorable, tu peux régler tes frais d'adhésion et activer ton compte.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">5</span><span class="step-title">Sécuriser l'application (code secret)</span></div>
  <div class="step-body full-card">
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">🔒</span>Un code à 4 chiffres pour ouvrir l'application</div>
      <p>À la <strong>première connexion</strong>, l'application te demande de choisir un <strong>code secret à 4 chiffres</strong>, à confirmer en le retapant. À chaque ouverture suivante, on te demandera ce code (ou ton empreinte si tu actives la biométrie).</p>
      <ul>
...
<section class="step">
  <div class="step-head"><span class="step-num">6</span><span class="step-title">L'accueil de l'espace membre</span></div>
  <div class="step-body">
    <img src="captures/mobile/07-home.png" alt="Accueil membre" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">🏠</span>Tout en un coup d'œil</div>
      <ul>
...
<section class="step">
  <div class="step-head"><span class="step-num">7</span><span class="step-title">Faire un versement</span></div>
  <div class="step-body">
    <img src="captures/mobile/14-versement.png" alt="Versement" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">💰</span>Deux canaux à ta disposition</div>
      <p>Depuis l'accueil, appuie sur :btn[+ Verser] ou le raccourci :tab[Verser]. Une fenêtre s'ouvre :</p>
      <ul>
      ...
      <p><strong>Heure limite : 17h00.</strong> Après 17h, le week-end ou un jour férié, le versement est crédité <strong>le prochain jour ouvré</strong>.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">8</span><span class="step-title">Suivre et gérer son crédit</span></div>
  <div class="step-body">
    <img src="captures/mobile/09-credit.png" alt="Crédit" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">📋</span>Tes crédits en un seul écran</div>
      <p>Onglet :tab[Crédit] (2<sup>e</sup> du bas). Pour chaque crédit en cours :</p>
      <ul>
      ...
      <p>Bouton :btn[+ Nouvelle demande] en bas pour soumettre une demande au comité crédit.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">9</span><span class="step-title">Commander son carnet de collecte</span></div>
  <div class="step-body">
    <img src="captures/mobile/10-carnet.png" alt="Carnet" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">📓</span>Trois étapes simples</div>
      <p>Onglet :tab[Carnet] (3<sup>e</sup> du bas). Tarif : <strong>1 000 XAF</strong>.</p>
      <ol>
      ...
      <p>Bouton :btn[Commander mon carnet] pour démarrer. L'historique des carnets déjà délivrés est visible plus bas.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">10</span><span class="step-title">Recevoir ses notifications</span></div>
  <div class="step-body">
    <img src="captures/mobile/12-notifications.png" alt="Notifications" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">🔔</span>Toutes tes infos en un endroit</div>
      <p>Accède au centre depuis la <strong>cloche en haut à droite</strong>. Cinq types de messages :</p>
      <ul>
      ...
      <p>Tape sur un message pour le marquer <strong>lu</strong>, ou :chip[Tout lire] en haut à droite.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">11</span><span class="step-title">Voir et modifier son profil</span></div>
  <div class="step-body">
    <img src="captures/mobile/11-profil.png" alt="Profil" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">👤</span>Mon compte de A à Z</div>
      <p>Onglet :tab[Profil] (4<sup>e</sup> du bas). Ton identité en haut (initiales, nom, email, numéro de membre <code>GF-2026-XXXX</code>) puis les sections :</p>
      <ul>
...
<section class="step">
  <div class="step-head"><span class="step-num">12</span><span class="step-title">Consulter l'historique</span></div>
  <div class="step-body">
    <img src="captures/mobile/13-historique.png" alt="Historique" />
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">📈</span>Toutes tes opérations classées</div>
      <p>Accès depuis le raccourci :tab[Historique] de l'accueil, ou :chip[Voir tout] sous les opérations récentes. Quatre filtres :</p>
      <ul>
        <li>:tab[Toutes] · :tab[Dépôts] · :tab[Intérêts] · :tab[Retraits]</li>
      </ul>
      <p>Les opérations sont <strong>regroupées par mois</strong> avec un résumé en tête. Tu peux taper sur une opération pour voir son détail (date, heure, source, référence, solde après opération).</p>
      <p>Le chargement est <strong>progressif</strong> : les 30 dernières s'affichent, les suivantes se chargent automatiquement en faisant défiler.</p>
    </div>
  </div>
</section>

<section class="step">
  <div class="step-head"><span class="step-num">13</span><span class="step-title">Les mandats d'avaliste</span></div>
  <div class="step-body full-card">
    <div class="step-card">
      <div class="step-card-head"><span class="step-badge">🤝</span>Quand un autre membre te désigne comme garant</div>
      <p>Un <strong>avaliste</strong> est un membre qui se porte garant d'un autre pour une demande de crédit. Si tu es sollicité, l'application te le signale.</p>
      <p>Accès depuis :tab[Crédit] → <strong>Mes mandats d'avaliste</strong> (zone en haut, visible si tu as une demande en attente). Chaque carte affiche :</p>
      <ul>
        <li>Nom et numéro du demandeur, montant, durée, date.</li>
        <li>Statut : :chip[En attente] · :chip[Acceptée] · :chip[Refusée] · :chip[Annulée].</li>
      </ul>
      <p>Pour les demandes :chip[En attente], deux boutons :</p>
      <ul>
