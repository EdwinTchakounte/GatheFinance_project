...
// ---------------------------------------------------------------------------
// Thumbnail (image inline ou icône fichier selon l'extension)
// ---------------------------------------------------------------------------
...
function DocumentThumbnail({
  ...
  if (!url) {
    return (
      <div className="flex h-24 w-20 shrink-0 items-center justify-center rounded-md border border-dashed border-line-200 bg-paper-soft text-xs text-ink-400">
        Aucun
      </div>
    );
  }
  return (
    <button
      type="button"
      onClick={onOpen}
      className="group relative h-24 w-20 shrink-0 overflow-hidden rounded-md border border-line-200 bg-paper-soft transition-shadow hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-700"
    ...
    >
      {isImage ? (
        ...
        <img
          src={url}
          alt={`Justificatif ${doc.member_prenom} ${doc.member_nom}`}
...
// ---------------------------------------------------------------------------
// Preview plein écran — image inline ou iframe (PDF) selon extension
// ---------------------------------------------------------------------------
      ...
      <header className="flex items-center justify-between border-b border-white/10 px-6 py-3 text-paper">
        <div className="min-w-0">
          <p className="truncate text-sm font-semibold">
            {doc.member_prenom} {doc.member_nom}{" "}
            <span className="text-paper/60">· {doc.member_numero}</span>
          </p>
          <p className="truncate text-xs text-paper/60">{doc.nom_original}</p>
        </div>
