...
CATALOG: list[dict] = [
    ...
    },
    {
        ...
        "description": "Seuil 'Ancien' (§3 Refonte 2026) : débloque voie SENIOR_BRC + rôle avaliste.",
        "type": "int",
        "default": "12",
        "min": 0,
        "max": 120,
    ...
    },
    {
        ...
        "description": "§5 Refonte 2026 — durée du contrat épargne classique avant restitution intégrale + frais.",
        "type": "int",
        "default": "12",
        "min": 1,
        "max": 60,
    ...
    # LOT 3 — Kill-switch legacy
    {
        ...
        "group": "savings",
        "label": "Intérêt collecte 1%/mois (LEGACY)",
        "description": "LEGACY 2025 — Active le crédit d'intérêts mensuels sur la collecte. Désactivé par défaut en 2026.",
        "type": "bool",
        "default": "false",
    },
    # LOT 4 — Cron clôture mensuelle
    {
        ...
        "description": "Active (true/false) le cron mensuel §4 Refonte 2026 (commission + restitution/bascule).",
        "type": "bool",
        "default": "true",
    },
    {
        ...
        "description": (
            ...
            "journalière (§4 BUSINESS_RULES_2026). Défaut 0.01 = 1 %. "
    ...
    },
    {
        ...
        "description": "A2 — Délai du rappel doux avant anniversaire annuel.",
        "type": "int",
        "default": "30",
        "min": 0,
    },
    # LOT 7 — Lender
    {
        ...
        "description": "Mode B — montant minimum d'une tranche. Évite les micro-tranches.",
        "type": "int",
        "default": "5000",
        "min": 0,
    },
    ...
    # LOT 8 — Funding
    {
        ...
        "description": "§7.3 — Au-delà, le cron pose AUTO_ACCEPTED sur la LenderConsentRequest.",
        "type": "int",
        "default": "24",
        "min": 1,
        "max": 168,
    ...
    },
    {
        ...
        "group": "eligibility",
        "label": "Voie MICROCAMPAIGN activée",
    ...
    },
    {
        ...
        "group": "eligibility",
        "label": "BRC obligatoire pour voie 1",
    ...
    },
    {
        ...
        "description": "Kill-switch garantie avaliste (§9.2 / Q9.4).",
        "type": "bool",
        "default": "true",
    },
    {
        ...
        "group": "seizure",
        "label": "Exclure tranches ENGAGEE (Q5)",
        "description": "Protection Q5 — ne saisit pas les LenderTranche.ENGAGEE. À NE PAS désactiver sauf audit forensique.",
        "type": "bool",
        "default": "true",
    },
    # LOT 14 — Judicial
